...
const HUD_PROFIL_SCENE := preload("res://scenes/ui/hud_profil.tscn")
...
func _input(event: InputEvent) -> void:
	...
	if Input.is_action_just_pressed("ui_cancel"):
		# Si un dialogue est actif, on ne touche à rien : on laisse l'event
		# redescendre vers dialogue_box.gd (_unhandled_input), qui gère
		# lui-même son propre Échap (quitter_immediatement()).
		if DialogueManager != null and DialogueManager.en_cours:
			return
